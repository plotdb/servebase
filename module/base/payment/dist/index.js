...
(function(){
  ...
  payment = {
    ...
    prepare: function(arg$){
      var payload, gateway;
      payload = arg$.payload, gateway = arg$.gateway;
      return ld$.fetch('/api/pay/sign', {
        method: 'POST'
      }, {
        json: {
          gateway: gateway,
    ...
    open: function(arg$){
      var url, method, data, form, attrs, k, v, input;
      url = arg$.url, method = arg$.method, data = arg$.data;
