...
(function(){
  var fs, yargs, express, colors, path, pino, lderror, pinoHttp, bodyParser, csurf, chokidar, i18nextHttpMiddleware, srcbuild, block, jsdom, pug, errorHandler, redisNode, mailQueue, i18n, aux, session, postgresql, auth, consent, captcha, libdir, rootdir, extdir, routes, exts, argv, cfgName, secret, e, withDefault, defaultConfig, backend;
  fs = require('fs');
  yargs = require('yargs');
