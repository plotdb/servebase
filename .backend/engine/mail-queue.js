...
(function(){
  var fs, path, config, colors, jsYaml, lderror, re2, curegex, jsdom, dompurify, nodemailer, nodemailerMailgunTransport, md, jsdomDoc, jsdomOption, dom, purify, reEmail, isEmail, libdir, rootdir, mailQueue;
  fs = require('fs');
  path = require('path');
